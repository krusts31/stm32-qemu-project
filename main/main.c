...
static void	 move_leds_right(const t_pins pins) {
...
static void	 move_leds_left(const t_pins pins) {
	 gpio_set_level(pins.D6, 1);
	 vTaskDelay(200 / portTICK_PERIOD_MS);
	 gpio_set_level(pins.D7, 1);
	 vTaskDelay(200 / portTICK_PERIOD_MS);
...
static void	 turn_off_leds(const t_pins pins) {
